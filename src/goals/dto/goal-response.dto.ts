...
export class GoalResponseDto {
  ...
  constructor(goal: Goal) {
    ...
    this.initialWeeklyTarget = goal.initialWeeklyTarget ? parseFloat(goal.initialWeeklyTarget.toString()) : null;
    this.currentWeeklyTarget = goal.currentWeeklyTarget ? parseFloat(goal.currentWeeklyTarget.toString()) : null;
